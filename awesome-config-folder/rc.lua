...
theme_path = "/usr/share/awesome/themes/NIN/theme.lua"
...
-- Define tags table.
tags = {}
tagnames = {'term', 'web', 'max', 'floats', 'email'}
taglayouts = { awful.layout.suit.tile.left, awful.layout.suit.max, awful.layout.suit.max, awful.layout.suit.floating, awful.layout.suit.floating }
...
for s = 1, screen.count() do
    ...
    my2wibox[s] = wibox({ position = "bottom", fg = beautiful.fg_normal, bg = beautiful.bg_normal })
    ...
    mywibox[s].screen = s
    my2wibox[s].widgets = { mytasklist[s], mylayoutbox[s]}
    my2wibox[s].screen = s
end
-- }}}
