...
theme.bg_focus      = "#07060a"
theme.bg_normal     = "#07060a"
theme.bg_urgent     = "#fce94f"
theme.bg_minimize   = "#f8dafb"

theme.fg_normal     = "#f8dafb"
theme.fg_focus      = "#01d2ff"
theme.fg_urgent     = "#2e3436"
theme.fg_minimize   = "#07060a"

theme.border_width  = "2"
theme.border_normal = "#07060a"
theme.border_focus  = "#cdefff"
...
-- MISC
theme.wallpaper_cmd         = { "feh --bg-scale /home/shearn89/Pictures/Ghosts/wallpaper9.jpg" }
